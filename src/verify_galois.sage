...
dec_types_decic = {
    ...
    ("10T1", 5, 0): [(1, 1, 10), (1, 2, 5), (1, 5, 2), (1, 10, 1), (2, 1, 5), (2, 5, 1), (5, 1, 2), (5, 2, 1), (10, 1, 1)],
    ("10T1", 1, 10): [(1, 1, 10), (1, 2, 5), (1, 5, 2), (1, 10, 1), (2, 1, 5), (2, 5, 1), (5, 1, 2), (5, 2, 1), (10, 1, 1)],
    ("10T1", 3, 10): [(1, 1, 10), (1, 2, 5), (1, 5, 2), (1, 10, 1), (2, 1, 5), (2, 5, 1)],
    ("10T1", 7, 10): [(1, 1, 10), (1, 2, 5), (1, 5, 2), (1, 10, 1), (2, 1, 5), (2, 5, 1)],
    ...
    ("10T2", 3, 10): [(1, 1, 10), (1, 2, 5), (1, 5, 2), (2, 1, 5)],
    ("10T2", 7, 10): [(1, 1, 10), (1, 2, 5), (1, 5, 2), (2, 1, 5)],
...
zc_octic = {
    ...
    ("8T1", 2 ** 4): [1, 2, 3, 5, 10, 35, 330],
    ("8T2", 2 ** 4): [1, 2, 3, 5, 10, 35, 330],
    ("8T3", 2 ** 4): [1, 2, 3, 5, 10, 35, 330],
    ("8T4", 2 ** 4): [1, 2, 3, 5, 10, 35, 330],
    ("8T5", 2 ** 4): [1, 2, 3, 5, 10, 35, 330],
    ("8T1", 3 ** 4): [0, 1, 2, 3, 10, 35, 330],
    ("8T2", 3 ** 4): [1, 2, 3, 10, 35, 330],
    ("8T3", 3 ** 4): [3, 10, 35, 330],
    ("8T4", 3 ** 4): [1, 2, 3, 10, 35, 330],
    ("8T5", 3 ** 4): [1, 2, 3, 10, 35, 330],
    ("8T1", 5 ** 4): [0, 1, 2, 3, 5, 10, 35, 330],
    ("8T2", 5 ** 4): [1, 2, 3, 5, 10, 35, 330],
    ("8T3", 5 ** 4): [3, 10, 35, 330],
    ("8T4", 5 ** 4): [2, 3, 5, 10, 35, 330],
    ("8T5", 5 ** 4): [2, 3, 5, 10, 35, 330],
    ("8T1", 7 ** 4): [0, 1, 2, 3, 5, 10, 35, 330],
    ("8T2", 7 ** 4): [1, 2, 3, 5, 10, 35, 330],
    ("8T3", 7 ** 4): [3, 10, 35, 330],
    ("8T4", 7 ** 4): [1, 2, 3, 10, 35, 330],
    ("8T5", 7 ** 4): [1, 2, 3, 10, 35, 330],
}
